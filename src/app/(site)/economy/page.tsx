...
export default async function EconomyPage() {
  const paths = await db.path.findMany({
    where: { isPublished: true, slug: { in: ["economy", "infrastructure", "reconstruction", "major_projects"] } },
    orderBy: { order: "asc" },
  ...
  return (
    <div>
      <PageHeader
        title="Economy"
        subtitle="Economic development, infrastructure, reconstruction, and major national projects."
      />
